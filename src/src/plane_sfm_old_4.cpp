...
//		myfile<<endl;
		cout<<" max inliers"<<error_least<<endl;
	}
	cout<<" max inliers"<<maxinliers<<" "<<s_1<<endl;
	s_1=(1/s_1);
	return s_1;	
}
...
void NormalFitting_n(vector<Point3f> points3d)			
{			
			pcl::PointCloud<pcl::PointXYZ> cloud;
			cloud.width  = points3d.size();
			cloud.height = 1;
	...
	/*	  for (size_t i = 0; i < inliers->indices.size (); ++i)
		 ...
		 pcl::io::savePCDFileASCII ("test_pcd_2.pcd", cloud1);
...
//	vector< vector <Point3f> > Points3D;
	...
	myfile.open("/home/prateek/Desktop/matches.txt",ios_base::app);
...
//	ofstream myfile;
	ofstream myfile2;
//
	myfile1.open("/home/prateek/Desktop/example.txt",ios_base::app);
	myfile2.open("/home/prateek/Desktop/example1.txt",ios_base::app);
